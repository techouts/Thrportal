...
export const MENU: MenuSection[] = [
  ...
  // },
  {
    ...
    items: [
      ...
      { label: "Profile", route: "/Me/Profile" },
      {
        label: "Attendance",
        route: "/Me/Attendance",
        requiresAny: ["attendance.read"],
      },
      {
        label: "Leave",
        route: "/Me/Leave",
        requiresAny: ["leave.requests.read", "leave.balance.read"],
      },
      {
        label: "Timesheet",
        route: "/Me/Timesheet",
        requiresAny: ["timesheets.read"],
      },
      // {
      //   label: "Expenses",
      //   route: "/Me/Expenses",
      //   requiresAny: ["expenses.read", "expenses.submit"],
      // },
      // {
      //   label: "Finance",
      //   route: "/Me/Finance",
      //   requiresAny: ["finance.payslips.read"],
      // },
      // {
      //   label: "Learning",
      //   route: "/Me/Learning",
      //   requiresAny: ["learning.read"],
      // },
      // {
      //   label: "Recognition",
      //   route: "/Me/Recognition",
      //   requiresAny: ["recognition.read"],
      // },
      // { label: "IJP", route: "/Me/IJP", requiresAny: ["ijp.postings.read"] },
      // {
      //   label: "Helpdesk",
      //   route: "/Me/Helpdesk",
      //   requiresAny: ["helpdesk.tickets.read_own"],
      // },
    ],
  },
  {
  ...
  //       requiresAny: ["reports.read"],
  //     },
  //     {
  //       label: "Custom Reports",
  //       route: "/Reports/Builder",
  //       requiresAny: ["reports.create"],
  //     },
  //     {
  //       label: "Scheduled",
  //       route: "/Reports/Scheduled",
  //       requiresAny: ["reports.schedule"],
  //     },
  //   ],
  // },
  // {
  ...
  //       requiresAny: ["analytics.read"],
  //     },
  //     {
  //       label: "Business Intelligence",
  //       route: "/Analytics/BI",
  //       requiresAny: ["analytics.advanced"],
  //     },
  //     {
  //       label: "Forecasting",
  //       route: "/Analytics/Forecasting",
  //       requiresAny: ["analytics.projections"],
  //     },
  //   ],
  // },
  //   {
  ...
  //         requiresAny: ["finance.invoices.*", "finance.*"],
  //       },
  //     ],
  //   },
  //   {
  ...
  //     items: [{ label: "Helpdesk", route: "/IT/Helpdesk" }],
  //   },
  //   {
  //     label: "Admin",
  //     requiresAny: ["admin.*", "*"],
