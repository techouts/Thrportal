...
export const DEV_USER_ID_MAP: Record<string, string> = {
  ...
  "intern@dev.local": "40404040-4040-4040-4040-404040404040",
};

export const DEV_USERS = [
  {
    email: "admin@dev.local",
    display_name: "Akhil Admin",
    roles: ["ADMIN"],
    password: "DevOnly!2025",
    mfa_enabled: true,
  },
  {
    email: "mgmt@dev.local",
    display_name: "Mona Management",
    roles: ["MANAGEMENT"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  ...
  },
  {
    ...
    display_name: "Ravi Recruiter",
    roles: ["RECRUITER"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "hiringmgr@dev.local",
    display_name: "Hari HiringMgr",
    roles: ["HIRING_MANAGER"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "staffingmgr@dev.local",
    display_name: "Sara StaffingMgr",
  ...
  {
    email: "pl@dev.local",
    display_name: "Pooja ProjectLead",
    roles: ["PROJECT_LEAD"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "dh@dev.local",
    display_name: "Dev DeliveryHead",
    roles: ["DELIVERY_HEAD"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "hrlead@dev.local",
    display_name: "Hema HR Lead",
    roles: ["HR_LEAD"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "hrmgr@dev.local",
    display_name: "Harsh HR Manager",
    roles: ["HR_MANAGER", "HIRING_MANAGER"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "finmgr@dev.local",
    display_name: "Finn Finance Mgr",
    roles: ["FINANCE_MANAGER"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "payroll@dev.local",
    display_name: "Pia Payroll",
  ...
  {
    email: "dpo@dev.local",
    display_name: "Deepa DPO",
    roles: ["DPO_PRIVACY"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "opshr@dev.local",
    display_name: "Ops HR User",
    roles: ["OPERATIONS_HR"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
  {
    email: "intern@dev.local",
    display_name: "Isha Intern",
    roles: ["INTERN"],
    password: "DevOnly!2025",
    mfa_enabled: false,
  },
