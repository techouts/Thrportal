...
const ITHelpdeskPage = () => {
  ...
  const loadTickets = async () => {
    try {
      const response = await helpdeskService.getDepartmentTickets('IT')
      if (response.success) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="IT Help Desk"
        description="Manage IT support tickets and technical issues"
        icon={Monitor}
      />
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="queue" className="space-y-6">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-semibold">IT Ticket Queue</h3>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={filters.category} onValueChange={(value) => setFilters(prev => ({ ...prev, category: value }))}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Login/Password">Login/Password</SelectItem>
        ...
        <TabsContent value="dashboard" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>IT Tickets by Category</CardTitle>
                <CardDescription>Distribution of IT support requests</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-2">
                      <span>System Access (2hr response)</span>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span>Hardware/Software (4hr response)</span>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span>Login/Password (1hr response)</span>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span>Network (2hr response)</span>
