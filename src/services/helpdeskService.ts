    ...
    const mockTickets: Ticket[] = [
      {
        ...
        priority: 'High',
        status: 'In Progress',
        title: 'Unable to login to company system',
        description: 'I am unable to login to the company system since yesterday. Getting invalid credentials error.',
  ...
  async getFAQs(category?: TicketCategory): Promise<ApiResponse<FAQ[]>> {
    ...
    const mockFAQs: FAQ[] = [
      ...
      },
      {
        ...
        answer: 'Navigate to Me > Leave section in the system and click on "Apply Leave". Fill in the required details and submit.',
