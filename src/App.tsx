            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      required={["finance.tax_declarations.read"]}
                    >
                      <MainLayout>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      required={["performance.feedback_requests.read"]}
                    >
                      <MainLayout>
                        <MePage defaultTab="Recognition" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                ...
                />
                <Route
                  path="/MyTeam/Recognition"
                  element={
                    <ProtectedRoute
                      required={["performance.feedback_requests.read"]}
                    >
                      <MainLayout>
                        <MyTeamPage defaultTab="Recognition" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/MyTeam/Learning"
                  element={
                    <ProtectedRoute required={["performance.goals.read"]}>
                      <MainLayout>
                        <MyTeamPage defaultTab="Learning" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/MyTeam/ProfileChanges"
                  element={
                ...
                />
                <Route
                  path="/Management/PrimaryQueues"
                  element={
                    <ProtectedRoute required={["management.*", "ownership.*"]}>
                      <MainLayout>
                        <ManagementPage defaultTab="PrimaryQueues" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  ...
                  element={
                    <ProtectedRoute required={["management.*", "ownership.*"]}>
                      <MainLayout>
                        <ManagementPage defaultTab="Escalations" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                ...
                <Route
                  path="/Hiring/JobRequisitions"
                  element={<Navigate to="/Hiring/JDs" replace />}
                />
                <Route
                ...
                <Route
                  ...
                  element={
                    ...
                    >
                      <MainLayout>
                        <HiringPage defaultTab="Approvals" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  ...
                  element={
                    ...
                    >
                      <MainLayout>
                        <HiringPage defaultTab="Candidates" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/Hiring/Ownership"
                  element={
                    <ProtectedRoute
                      required={[
                        "ownership.assign",
                    ...
                    >
                      <MainLayout>
                        <HiringPage defaultTab="Ownership" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/Hiring/Assignment"
                  element={<Navigate to="/Hiring/Ownership" replace />}
                />
                <Route
                  path="/Hiring/Assignment/Manage"
                  element={<Navigate to="/Hiring/Ownership" replace />}
                />
                <Route
                  path="/Hiring/Assignment/Unassigned"
                  element={
                    <Navigate to="/Hiring/Ownership?view=unassigned" replace />
                  }
                />
                <Route
                  path="/Hiring/Assignment/Unattended"
                  element={
                    <Navigate to="/Hiring/Ownership?view=unattended" replace />
                  }
                />
                <Route
                  path="/Hiring/Assignment/Reports"
                  element={<Navigate to="/Hiring/Ownership" replace />}
                />
                <Route
                ...
                />
                <Route
                  path="/Hiring/Settings/:topTab/:subTab"
                  element={
                    <ProtectedRoute required={["hiring.settings.*"]}>
                      <MainLayout>
                        <HiringSettingsPage />
                ...
                <Route
                  path="/Hiring/Settings/Targets"
                  element={
                    <Navigate
                      to="/Hiring/Settings/performance/targets?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/Approval-Rules"
                  element={
                    <Navigate
                      to="/Hiring/Settings/workflow/approvals?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/JD-Parser"
                  element={
                    <Navigate
                      to="/Hiring/Settings/content/parser?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/Offer-Matrix"
                  element={
                    <Navigate
                      to="/Hiring/Settings/content/offers?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/SLA"
                  element={
                    <Navigate
                      to="/Hiring/Settings/workflow/sla?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/Rejection-Reasons"
                  element={
                    <Navigate
                      to="/Hiring/Settings/content/reject-reasons?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/Feedback-Followups"
                  element={
                    <Navigate
                      to="/Hiring/Settings/workflow/feedback?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/Compliance-Vendors"
                  element={
                    <Navigate
                      to="/Hiring/Settings/compliance/vendors?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Settings/Global-Defaults"
                  element={
                    <Navigate
                      to="/Hiring/Settings/defaults/global?redirected=true"
                      replace
                    />
                  }
                />
                <Route
                  path="/Hiring/Pipeline/Settings"
                  element={
                    <Navigate
                      to="/Hiring/Settings/workflow/pipeline?redirected=true"
                      replace
                    />
                  }
                />
                ...
                <Route
                  path="/CRM/Clients"
                  element={<Navigate to="/CRM/ClientDesk" replace />}
                />
                <Route
                  path="/CRM/Accounts"
                  element={<Navigate to="/CRM/ClientDesk" replace />}
                ...
                <Route
                  path="/Projects"
                  element={<Navigate to="/Projects/Assignments" replace />}
                />
                <Route
                  path="/Projects/Board"
                  element={<Navigate to="/Projects/Assignments" replace />}
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      required={["employees.directory.read", "employees.read"]}
                    >
                      <MainLayout>
                        <OrgPage defaultTab="Structure" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute required={["helpdesk.dashboard.read"]}>
                      <MainLayout>
                        <HRPage defaultTab="Helpdesk" />
                      </MainLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/HR/OnOffboarding"
                  element={
